...
CREATE TABLE `empleo` (
  `id` int NOT NULL,
  `Descripcion_Empleo` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `empleo` VALUES (1,'Ejército Argentino'),(2,'Patrior'),(3,'Nasa'),(4,'Mendoza Norte'),(5,'WESTECH');
...
-- Dump completed on 2022-10-12  3:15:44
